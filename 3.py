...
print (c)
if (c == 0):
	print("Se llegó al estado final. Se ha generado archivo con historia (datos3.txt) \n La cadena es par")
else:
	print("No se llegó al estado final. Se ha generado archivo con historia (datos3.txt) \n La cadena es inpar")
